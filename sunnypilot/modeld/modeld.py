...
def main(demo=False):
  ...
  sm = SubMaster(["deviceState", "carState", "roadCameraState", "liveCalibration", "driverMonitoringState", "carControl", "liveDelay", "carrotMan"])
  ...
  while True:
    ...
    if model_output is not None:
      ...
      DH.update(sm['carState'], sm['carControl'].latActive, lane_change_prob, sm['carrotMan'] if sm.alive.get('carrotMan', False) else None)
