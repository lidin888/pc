...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    // SPÃ§â€ºÂ¸Ã¥â€¦Â³Ã¥Ââ€šÃ¦â€¢Â°
    {"LaneTurnDesire", PERSISTENT},
    {"LaneTurnValue", PERSISTENT},
    {"LagdToggle", PERSISTENT},
    {"LagdToggleDelay", PERSISTENT},
    {"CameraOffset", PERSISTENT},  // Ã¦â€˜â€žÃ¥Æ'ÂÃ¥Â¤Â´YÃ¨Â½Â´Ã¥ÂÂÃ§Ã§Â»Â»Ã¯Â¼Å'Ã¥Ââ€�Ã¤Â½Â0.01Ã§Â±Â³

    // ToyotaÃ§â€°Â¹Ã¨Â°Æ'Ã¥Ââ€šÃ¦â€¢Â°
    ...
    // Ã§Â«Â¯Ã¥Ë†Â°Ã§Â«Â¯Ã¦Å½Â§Ã¥Ë†Â¶Ã¥Ââ€šÃ¦â€¢Â°
    {"EndToEndToggle", PERSISTENT},
    {"EndToEndForceLaneChange", PERSISTENT},
};