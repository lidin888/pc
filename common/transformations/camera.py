...
_ar_ox_config = DeviceCameraConfig(CameraConfig(2592, 1944, 3264), _ar_ox_fisheye, _ar_ox_fisheye)  # USB camera calibrated focal length (avg of fx=1657.98, fy=1664.95)
