...
_ar_ox_fisheye = CameraConfig(2592, 1944, 990.0)  # focal length probably wrong? magnification is not consistent across frame
_os_fisheye = CameraConfig(2688 // 2, 1520 // 2, 567.0 / 4 * 3)
_ar_ox_config = DeviceCameraConfig(CameraConfig(2592, 1944, 3264.0), _ar_ox_fisheye, _ar_ox_fisheye)  # USB camera calibrated focal length (avg of fx=1657.98, fy=1664.95)
